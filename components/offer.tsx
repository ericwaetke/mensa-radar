				...
				<a>
					<div className="my-4 p-5 flex gap-8 rounded-xl bg-background-container justify-between">
						...
						animate="show">
							...
							<div className="mt-5 flex justify-between flex-row items-start gap-y-2">
								<motion.p variants={dayVariantAnimation} className="font-medium text-black text-sm flex gap-2 items-center">
									<Pill>{offer.preise.preis_s} €</Pill>
									<span className='text-gray-400 min-w-max'>{offer.preise.preis_g} €</span>
								</motion.p>
								<motion.div variants={dayVariantAnimation} className='flex flex-wrap gap-2 justify-end'>
