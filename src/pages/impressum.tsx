			...
			<main>
				<Link href="/">
					<a className="flex items-center gap-4 p-2 pl-0">
						...
						<h2 className="w-full text-center text-lg font-bold">Zurück zur Übersicht</h2>
					</a>
				</Link>
				<div className="font-sans-reg">
					...
					<h2 className="mt-4 font-sans-bold">Sticker</h2>
					...
					<h2 className="mt-4 font-sans-bold">Quellen</h2>
					...
					<h1 className="mb-4 mt-8 text-3xl">Impressum</h1>
					<h2 className="mt-4 font-sans-bold">Diensteanbieter</h2>
					<p>Eric Wätke</p>
					<p>Benziner Chaussee 2</p>
					<p>19386 Lübz</p>
					<h2 className="mt-4 font-sans-bold">Kontaktmöglichkeiten</h2>
					E-Mail-Adresse: 
					<p><a href="mailto:email@ericwaetke.de">email@ericwaetke.de</a></p>
					Telefon: 
					<p>01719388606</p>
					<h2 className="mt-4 font-sans-bold">Haftungs- und Schutzrechtshinweise</h2>
