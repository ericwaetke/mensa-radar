...
export default function Mensa(props) {
    ...
    return (
        <div className="space-y-6 break-words mx-5 mt-12 xl:w-1/2 xl:mx-auto">
			<style jsx>
				{`
					.daySelection{
						position: relative;
			...
			<div className="daySelection">
				<motion.div 
					...
					{
						days.map((day, i) => {
							let isSelected = props.selectedWeekday - (5 - days.length) === i
