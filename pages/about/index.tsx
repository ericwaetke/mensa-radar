...
export default function Impressum () {
	...
	return (
		<div className="p-4 pb-0 space-y-6 lg:w-1/2 lg:px-0 lg:pb-4 lg:mx-auto flex flex-col h-full justify-between bg-[#DAFFE4]">
			<Head>
			...
			<main>
				<div className="flex justify-between items-center">
					<h1 className="text-3xl font-sans-bold">Mensa<br />Radar</h1>
